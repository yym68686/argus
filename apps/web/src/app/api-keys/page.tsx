            ...
            {showSkeleton ? (
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Badge tone="success">Default Native Host</Badge>
                  <Badge tone="default">Workspace on Desktop</Badge>
                </div>
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  The installer downloads the right host-agent binary for this system, uses your Desktop as the
                  workspace base, and starts the local Codex host in one step.
                </p>
              </div>
            )}
          </PanelCard>

          <PanelCard title="Connected Computers">
            {showSkeleton ? (
              ...
              <EmptyState title="No computers connected yet" />
            )}
          </PanelCard>
        </section>

        <section className="space-y-4">
          <PanelCard title="Token">
            {showSkeleton ? (
              <div className="space-y-3">
                <Skeleton className="h-4 w-32 rounded-full" />
              ...
              <div className="space-y-3">
                ...
                <Fact label="Binding" value="Global default native host" />
                <Fact label="Installer" value={platform === "windows" ? "install.ps1" : "install.sh"} mono />
                <div className="rounded-[18px] border border-border/70 bg-background/18 p-3">
                  <div className="mb-2 text-sm font-medium text-foreground">Enrollment token</div>
                  <Textarea
                    readOnly
