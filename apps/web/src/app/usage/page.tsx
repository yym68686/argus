      ...
      <div className="grid gap-4">
        ...
        >
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            ...
            <Fact label="Rows loaded" value={usageUnavailable ? "Unavailable" : formatInt(usage?.events.length)} />
            <Fact label="Last request" value={usageUnavailable ? "Unavailable" : formatWhen(filteredSummary?.lastAtMs)} />
          </div>
        </PanelCard>
        ...
        {usageUnavailable ? (
          <PanelCard
            ...
            subtitle="The gateway did not return the usage ledger for the current filter."
          >
              ...
              <PanelCard
                ...
                subtitle={
                  overview
                    ...
                    : overviewError
                      ? "Sorted by rolling 24h token usage. Gateway overview is temporarily unavailable."
